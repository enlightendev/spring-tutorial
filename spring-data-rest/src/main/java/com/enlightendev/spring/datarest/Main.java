...
import com.enlightendev.spring.datarest.dao.TagRepository;
import com.enlightendev.spring.datarest.json.ResourcesMapper;
...
// Tell Spring to automatically create a JPA implementation of our repositories
...
public class Main extends RepositoryRestMvcConfiguration {
    ...
    // extract a list of tags, etc. using Retrofit. You can remove this
