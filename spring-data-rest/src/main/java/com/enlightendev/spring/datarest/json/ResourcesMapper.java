package com.enlightendev.spring.datarest.json;
 ...
 * additional fields to the JSON so that we don't just get back a list of Tag objects.
 * <p/>
 * For our TagRepository, the default output would like something like this for the /video :
 * <p/>
 * {
 * "_links": {
 * "search": {
 * "href": "http://localhost:8080/tag/search"
 * }
 * },
 * "_embedded": {
 * "tags": [
 ...
 * "_links": {
 * "self": {
 * "href": "http://localhost:8080/tag/1"
 * }
 * }
 * }
 * ]
 ...
 * Tag objects, this ObjectMapper overrides the default JSON marshalling of Spring Data Rest so
 ...
 * ]
 * <p/>
 * This alternate format allows us to directly unmarshall the HTTP response bodies from the TagRepository
 * into a list of Tag objects.
 */
public class ResourcesMapper extends ObjectMapper {
    ...
    // creates with the Tags it obtains from your TagRepository
    ...
    private JsonSerializer<Resources> serializer = new JsonSerializer<Resources>() {
        ...
        public void serialize(Resources value, JsonGenerator jgen,
            ...
            // that we care about (e.g., the list of Tag objects)
            Object content = value.getContent();
            // Instead of all of the Resources member variables, etc.
            // Just mashall the actual content (Tags) into the JSON
